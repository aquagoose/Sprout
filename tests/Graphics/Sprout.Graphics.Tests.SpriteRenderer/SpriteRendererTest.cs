...
public sealed class SpriteRendererTest() : TestBase("Sprite Renderer Test")
{
    ...
    protected override void Loop(float dt)
    {
        ...
        using Graphics.SpriteRenderer.Pass pass = _renderer.BeginPass();
        ...
        pass.Draw(_texture, new Vector2(10, 0), new Vector2(192, 0), new Vector2(20, 100), new Vector2(128, 128));
        
        // Test the source rectangle functionality.
        // This should show a 128x64 box, showing the (64,64) and (128,64) squares.
        pass.Draw(_texture, new Vector2(600, 500), new Rectangle(64, 64, 128, 64));
        
        // Test the manual sizing function.
        // The sprite should be squished with a size of 256x64
        pass.Draw(_texture, new Vector2(300, 0), new Size(256, 64));
        ...
        pass.Draw(_texture, Matrix3x2.CreateRotation(_rotation) * Matrix3x2.CreateTranslation(200, 150), tint: Color.Orange);
        ...
        pass.Draw(_texture, new Vector2(600, 300), _rotation * 2, new Vector2(2, 1),
        ...
        pass.Draw(_texture, new Vector2(0, yPos), new Rectangle(64, 0, 64, 64), flip: SpriteFlip.FlipX);
        // Test Y flipping. The text "Flip Y" should be at the correct orientation,
        // and the sprite should only show the (64,64) box.
        pass.Draw(_texture, new Vector2(xSize, yPos), new Rectangle(64, 64, 64, 64), flip: SpriteFlip.FlipY);
        // Test XY flipping. The text "Flip XY" should be at the correct orientation,
        // and the sprite should show only the (64,128) box.
        pass.Draw(_texture, new Vector2(xSize * 2, yPos), new Rectangle(64, 128, 64, 64), flip: SpriteFlip.FlipXY);
    }
